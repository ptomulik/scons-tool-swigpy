...
TEXMFCONFIG ~\.texlive\texmf-config
TEXMFHOME ~\texmf
TEXMFLOCAL ${USERPROFILE}\TeXLive\texmf-local
TEXMFSYSCONFIG ${USERPROFILE}\TeXLive\texmf-config
TEXMFSYSVAR ${USERPROFILE}\TeXLive\texmf-var
TEXMFVAR ~\.texlive\texmf-var
binary_win32 1
##collection-basic 1
